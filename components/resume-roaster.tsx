...
const initialTechExperts = [
	...
	},
	{
		...
		name: "Neeraj Walia",
		image:
			"https://pbs.twimg.com/profile_images/1688266765095276544/EyCtuQS2_400x400.jpg",
	},
	{
		id: "samay",
		name: "Samay Raina",
		image:
			"https://pbs.twimg.com/profile_images/1678360651507585026/Kn8Z0J1__400x400.jpg",
	},
];
...
export function ResumeRoasterComponent() {
	...
	const [celebrityComparison, setCelebrityComparison] = useState<string | null>(
		null
	);
	...
	const finishRoast = () => {
		const expert =
			techExperts.find((e) => e.id === selectedExpert)?.name || selectedExpert;
		const roasts = [
		...
		setVisualCritique(
			"Your formatting looks like it was done by a caffeinated monkey using Microsoft Paint."
		);
		setCompareResult(
	...
	return (
		<div className="min-h-screen bg-gradient-to-b from-purple-50 to-yellow-50 flex flex-col items-center justify-between p-8">
			...
			<div className="w-full max-w-4xl flex flex-col items-center text-center space-y-8">
				...
				<p className="text-xl">
					Upload your resume and get a fun, insightful roast from tech experts
				</p>
			...
			<Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Enter your email to be notified when this premium feature becomes
							available.
						</DialogDescription>
					</DialogHeader>
